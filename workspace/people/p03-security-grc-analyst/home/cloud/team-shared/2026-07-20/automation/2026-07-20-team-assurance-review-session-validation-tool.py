"""Synthetic defensive validation helper for p03-full-003802; no network or filesystem access.
Assigned team-shared topic: review-session; record focus: defensive validation; locator: 2026-07-20-team-assurance-review-session-validation-tool-py;assigned_source_slot=003802;ledger_spine_refs=org.cobalt-harbor=Cobalt Harbor Systems | team.soc=Security Operations owns bounded SIEM exports detection review evidence and incident evidence-chain handoff | date.2026-07-20=Seven-day follow-up validates closure evidence and residual-risk status;spine_dates=2026-07-13;2026-07-14;2026-07-15;2026-07-20.
"""
ARTIFACT_ID = "p03-full-003802"
CONTROL_ID = "AC-27"
RECORD_FOCUS = "defensive validation"

def validate_review(record: dict) -> list[str]:
    """Return missing governance fields for this synthetic review-session record."""
