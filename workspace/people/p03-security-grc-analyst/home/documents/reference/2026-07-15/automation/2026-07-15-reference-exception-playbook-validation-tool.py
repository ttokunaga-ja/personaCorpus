...
ARTIFACT_ID = '2026_07_15_reference_exception_playbook_validation_tool_py_s007889'
...
SPINE_REFERENCES = [{'spine_id': 'org.cobalt-harbor', 'canonical_value': 'Cobalt Harbor Systems is a fictional managed logistics and harbor-operations platform organization.'}, {'spine_id': 'date.2026-07-15', 'canonical_value': 'Control owner validates the remediation plan and retention disposition.'}]
...
REFERENCE_CHECKPOINT = 'AC27-RF-kqk'
