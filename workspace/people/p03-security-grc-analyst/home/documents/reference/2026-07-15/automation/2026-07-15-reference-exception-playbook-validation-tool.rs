// Synthetic offline AC-27 evidence validator: 2026_07_15_reference_exception_playbook_validation_tool_rs_s007789.
...
const SPINE_2: &str = "date.2026-07-15: Control owner validates the remediation plan and retention disposition.";
const REFERENCE_CHECKPOINT: &str = "AC27-RF-kmo";
