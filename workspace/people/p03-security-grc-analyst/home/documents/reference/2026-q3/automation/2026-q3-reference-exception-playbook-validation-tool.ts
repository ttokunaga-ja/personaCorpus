/** Synthetic offline AC-27 evidence validator: 2026_q3_reference_exception_playbook_validation_tool_ts_s003357. */
...
export const spine2 = {"spine_id": "control.ac-27", "canonical_value": "Aegis Control AC-27 requires evidence-backed quarterly access review, approval, retention, and exception disposition."};
export const spine3 = {"spine_id": "period.2026-q3", "canonical_value": "Governance planning period from 2026-07-01 through 2026-09-30."};
export const referenceCheckpoint = 'AC27-RF-dyc';
