...
CREATE TABLE IF NOT EXISTS vendor_risk_control_fact_007347 (
...
INSERT INTO vendor_risk_control_fact_007347
  (record_id, control_id, case_id, risk_id, evidence_set, residual_risk, source_note)
VALUES
  ('VRF-007347', 'AC-27', 'CASE-260713-184', 'RISK-031', 184, 'Medium', 'Synthetic defensive supplier assurance record; action ACT-260713-013 due 2026-07-31.');
