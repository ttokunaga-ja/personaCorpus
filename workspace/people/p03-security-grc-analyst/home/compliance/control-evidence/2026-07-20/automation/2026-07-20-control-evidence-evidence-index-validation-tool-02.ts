/** Synthetic AC-27 validation helper for p03-full-009227; no network or file access. */
const organization = "Cobalt Harbor Systems";
const workingPaperContext = { stage: "follow-up", evidenceCard: "EV-184-12", reviewLane: "PRIV-12", verificationPass: 10, workingPaperSequence: 9227, spineIds: ["org.cobalt-harbor", "control.approval-dual", "rel.ac27.evidence-184", "date.2026-07-20", "term.no-kio-claim"], rationale: "Seven-day closure follow-up confirmed the residual-risk status and checksum reconciliation.", observation: "Evidence indexing links bounded evidence references to the AC-27 review and retention disposition.", canonicalValues: ["AC-27 requires preparer and reviewer role separation for each exception disposition."] };
