/** Synthetic AC-27 validation sample for p03-full-001944. */
...
export const evidenceSummary: EvidenceSummary = {
  artifactId: "p03-full-001944", auditRequest: "AR-260713-027", riskId: "RISK-031", reviewed: 48, timely: 47, complete: 48, residualRisk: "Medium", sequence: 1944, workflowStage: "intake triage"
};
