/** Synthetic AC-27 validation sample for p03-full-006462. */
...
export const evidenceSummary: EvidenceSummary = {
  artifactId: "p03-full-006462", auditRequest: "AR-260713-027", riskId: "RISK-031", reviewed: 48, timely: 47, complete: 48, residualRisk: "Medium", sequence: 6462, workflowStage: "intake triage"
};

export const positiveSpineReferences = [{"id":"org.cobalt-harbor","value":"Cobalt Harbor Systems (CHS), a fictional managed logistics and harbor-operations platform."},{"id":"audit.ar-260713-027","value":"AR-260713-027 is the fictional AC-27 audit request for bounded review material."},{"id":"date.2026-07-20","value":"2026-07-20 is the seven-day closure-evidence and residual-risk follow-up."}] as const;
