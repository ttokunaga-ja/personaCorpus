CREATE TABLE IF NOT EXISTS incident_evidence_002847 (
...
INSERT INTO incident_evidence_002847 VALUES
  ('IR-002847', 'Cobalt Harbor Systems', 'CASE-260713-184', 'AC-27', 184, 'RISK-031', 'Medium', 48, 47, 48);
