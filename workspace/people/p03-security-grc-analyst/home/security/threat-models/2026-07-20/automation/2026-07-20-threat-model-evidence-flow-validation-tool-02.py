"""Synthetic defensive AC-27 validation for 2026-07-20-threat-model-evidence-flow-validation-tool-py-s000342.py on 2026-07-20."""
from __future__ import annotations

RECORD_ID = "p03-src-000342"
ARTIFACT_FILENAME = "2026-07-20-threat-model-evidence-flow-validation-tool-py-s000342.py"
