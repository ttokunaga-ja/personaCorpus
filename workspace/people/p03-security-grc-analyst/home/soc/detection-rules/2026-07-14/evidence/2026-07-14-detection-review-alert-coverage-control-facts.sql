...
INSERT INTO detection_review_evidence VALUES ('p03-full-005785', 'p03-src-005785', 'AC-27', 184, 48, 47, 48, 'Medium', TRUE);
-- review_context: {"decision": "AC-27 control review confirms preparer and reviewer separation; CASE-260713-184 retains RISK-031 at Medium residual risk.", "evidence_reference": "evidence set 184, reconciliation lane 005785", "review_date_or_period": "2026-07-14", "review_topic": "alert coverage", "synthetic_boundary": "defensive governance record only; no live telemetry, credentials, personal data, or routable targets"}
