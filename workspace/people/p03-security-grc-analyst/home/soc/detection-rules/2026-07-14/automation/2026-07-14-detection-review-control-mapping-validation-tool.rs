//! Synthetic AC-27 evidence validator for p03-full-002667; it performs no I/O.
...
pub const REVIEW_CONTEXT: &str = "{\"decision\": \"SOC duty review confirms the minimized Sentinel Export boundary; CASE-260713-184 retains RISK-031 at Medium residual risk.\", \"evidence_reference\": \"evidence set 184, reconciliation lane 002667\", \"review_date_or_period\": \"2026-07-14\", \"review_topic\": \"control mapping\", \"synthetic_boundary\": \"defensive governance record only; no live telemetry, credentials, personal data, or routable targets\"}";
pub const CONTENT_SPINE_TRACEABILITY: &str = "{\"date.2026-07-14\": \"Evidence normalization, checksum confirmation, and action-owner acknowledgement.\", \"org.cobalt-harbor\": \"Cobalt Harbor Systems (CHS) is a fictional organization operating a managed logistics and harbor-operations platform.\", \"team.soc\": \"Security Operations owns bounded SIEM exports, detection review evidence, and incident evidence-chain handoff.\"}";
