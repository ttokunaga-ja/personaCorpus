...
RECORD_ID = 'p03-full-004612'
SOURCE_ID = 'p03-src-004612'
...
REVIEW_CONTEXT = {'review_topic': 'rule assurance', 'review_date_or_period': '2026-07-20', 'evidence_reference': 'evidence set 184, reconciliation lane 004612', 'decision': 'AC-27 control review confirms preparer and reviewer separation; CASE-260713-184 retains RISK-031 at Medium residual risk.', 'synthetic_boundary': 'defensive governance record only; no live telemetry, credentials, personal data, or routable targets'}
