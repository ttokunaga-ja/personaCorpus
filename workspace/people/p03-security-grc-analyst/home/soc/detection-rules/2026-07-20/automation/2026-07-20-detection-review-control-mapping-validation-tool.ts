/** Synthetic AC-27 evidence validator for p03-full-006535; no live-system access. */
...
export const reviewContext = {"decision": "AC-27 control review confirms preparer and reviewer separation; CASE-260713-184 retains RISK-031 at Medium residual risk.", "evidence_reference": "evidence set 184, reconciliation lane 006535", "review_date_or_period": "2026-07-20", "review_topic": "control mapping", "synthetic_boundary": "defensive governance record only; no live telemetry, credentials, personal data, or routable targets"} as const;
