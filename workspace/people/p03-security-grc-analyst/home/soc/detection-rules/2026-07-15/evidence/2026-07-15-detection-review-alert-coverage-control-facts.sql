...
INSERT INTO detection_review_evidence VALUES ('p03-full-006285', 'p03-src-006285', 'AC-27', 184, 48, 47, 48, 'Medium', TRUE);
-- review_context: {"decision": "SOC duty review confirms the minimized Sentinel Export boundary; CASE-260713-184 retains RISK-031 at Medium residual risk.", "evidence_reference": "evidence set 184, reconciliation lane 006285", "review_date_or_period": "2026-07-15", "review_topic": "alert coverage", "synthetic_boundary": "defensive governance record only; no live telemetry, credentials, personal data, or routable targets"}
-- content_spine_traceability: {"date.2026-07-15": "Control owner validates the remediation plan and retention disposition.", "org.cobalt-harbor": "Cobalt Harbor Systems (CHS) is a fictional organization operating a managed logistics and harbor-operations platform.", "team.soc": "Security Operations owns bounded SIEM exports, detection review evidence, and incident evidence-chain handoff."}
