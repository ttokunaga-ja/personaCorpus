//! Synthetic AC-27 evidence validator for p03-full-009187; it performs no I/O.
...
pub const REVIEW_CONTEXT: &str = "{\"decision\": \"AC-27 control review confirms preparer and reviewer separation; CASE-260713-184 retains RISK-031 at Medium residual risk.\", \"evidence_reference\": \"evidence set 184, reconciliation lane 009187\", \"review_date_or_period\": \"2026-07-15\", \"review_topic\": \"control mapping\", \"synthetic_boundary\": \"defensive governance record only; no live telemetry, credentials, personal data, or routable targets\"}";
