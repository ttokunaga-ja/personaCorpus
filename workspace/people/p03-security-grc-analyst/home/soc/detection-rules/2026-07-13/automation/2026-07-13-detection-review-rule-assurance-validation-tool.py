...
RECORD_ID = 'p03-full-002700'
SOURCE_ID = 'p03-src-002700'
...
REVIEW_CONTEXT = {'review_topic': 'rule assurance', 'review_date_or_period': '2026-07-13', 'evidence_reference': 'evidence set 184, reconciliation lane 002700', 'decision': 'SOC duty review confirms the minimized Sentinel Export boundary; CASE-260713-184 retains RISK-031 at Medium residual risk.', 'synthetic_boundary': 'defensive governance record only; no live telemetry, credentials, personal data, or routable targets'}
