...
const RECORD: ClosedRecord = ClosedRecord { record_id: "p03-full-004000", case_id: "CASE-260713-184", control: "AC-27", risk_id: "RISK-031", review_focus: "attestation timeliness", closure_finding: "the control conclusion is supported by synthetic records", disposition_follow_up_anchor: "2026-07-14" };
