...
const RECORD: ClosedRecord = ClosedRecord { record_id: "p03-full-004034", case_id: "CASE-260713-184", control: "AC-27", risk_id: "RISK-031", review_focus: "approval separation", closure_finding: "the bounded evidence set is complete", disposition_follow_up_anchor: "2026-07-20,2026-07-14" };
const LEDGER_TRACEABILITY: &[(&str, &str)] = &[("org.cobalt-harbor", "Cobalt Harbor Systems (CHS), a fictional managed logistics and harbor-operations platform."), ("date.2026-07-20", "Seven-day follow-up validates closure evidence and residual-risk status."), ("date.2026-07-14", "Evidence normalization, checksum confirmation, and action-owner acknowledgement.")];
