...
const RECORD: ClosedRecord = ClosedRecord { record_id: "p03-full-009975", case_id: "CASE-260713-184", control: "AC-27", risk_id: "RISK-031", review_focus: "follow-up confirmation", closure_finding: "the residual rating remains proportionate", disposition_follow_up_anchor: "2026-07-13" };
const LEDGER_TRACEABILITY: &[(&str, &str)] = &[("org.cobalt-harbor", "Cobalt Harbor Systems (CHS), a fictional managed logistics and harbor-operations platform."), ("case.case-260713-184", "CASE-260713-184, the synthetic evidence intake case for evidence set 184; not a real incident."), ("date.2026-07-13", "Primary review date: evidence intake opens 08:30 UTC and the AC-27 review closes 16:45 UTC.")];
