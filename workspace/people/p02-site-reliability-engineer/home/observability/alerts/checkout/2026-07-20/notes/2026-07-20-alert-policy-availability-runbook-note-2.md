...
Artifact p02-full-010312 / source p02-src-010312 / scope p02-primary-07. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 20 alert policy availability runbook note md reference applies to observability/alerts and binds to content spine IDs: org.ntc, slo.checkout.latency, rel.slo.2026-q3, date.2026-07-20, term.no-kio-claim.
...
Record fingerprint: f69b6936b17813eb
