...
Artifact p02-full-013343 / source p02-src-013343 / scope p02-primary-07. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 14 alert policy export gap runbook note markdown reference applies to observability/alerts and binds to content spine IDs: org.ntc, measure.burn-rate-short, rel.slo.2026-q3, date.2026-07-14, term.no-kio-claim.
...
Record fingerprint: 6b2fa357f9611a8c
