...
Artifact p02-full-014507 / source p02-src-014507 / scope p02-primary-07. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 15 alert policy payment errors runbook note markdown reference applies to observability/alerts and binds to content spine IDs: org.ntc, measure.burn-rate-short, rel.slo.2026-q3, date.2026-07-15, term.no-kio-claim.
...
Record fingerprint: 10ca820ab510969d
