...
Artifact p02-full-012011 / source p02-src-012011 / scope p02-primary-07. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 13 alert policy payment errors runbook note md reference applies to observability/alerts and binds to content spine IDs: org.ntc, measure.burn-rate-short, rel.slo.2026-q3, date.2026-07-13, term.no-kio-claim.
...
Record fingerprint: 01a1255f8317fb02
