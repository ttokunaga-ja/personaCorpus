...
Artifact p02-full-012778 / source p02-src-012778 / scope p02-primary-07. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 13 alert policy queue depth runbook note markdown reference applies to observability/alerts and binds to content spine IDs: org.ntc, slo.checkout.latency, rel.slo.2026-q3, date.2026-07-13, term.no-kio-claim.
...
Record fingerprint: 07596946c8a2f504
