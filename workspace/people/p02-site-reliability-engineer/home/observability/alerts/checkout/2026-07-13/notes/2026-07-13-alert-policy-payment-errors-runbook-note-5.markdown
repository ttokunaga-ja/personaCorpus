...
Artifact p02-full-014843 / source p02-src-014843 / scope p02-primary-07. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 13 alert policy payment errors runbook note markdown reference applies to observability/alerts and binds to content spine IDs: org.ntc, measure.burn-rate-short, rel.slo.2026-q3, date.2026-07-13, term.no-kio-claim.
...
Record fingerprint: 88d0638493e4837c
