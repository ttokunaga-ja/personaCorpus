2026 07 20 Telemetry Export Postgres Performance Runbook Note Markdown
======================================================================
...
Artifact p02-full-001876 / source p02-src-001876 / scope p02-primary-09. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 20 telemetry export postgres performance runbook note markdown reference applies to observability/log-exports and binds to content spine IDs: org.ntc, measure.log-export-gap, rel.inc260713.timeline, date.2026-07-20, term.no-kio-claim.
...
Record fingerprint: 72d3e7f57e35b4fa
