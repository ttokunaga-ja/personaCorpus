2026 07 13 Telemetry Export Regional Ingress Runbook Note Markdown
==================================================================
...
Artifact p02-full-009907 / source p02-src-009907 / scope p02-primary-09. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 13 telemetry export regional ingress runbook note markdown reference applies to observability/log-exports and binds to content spine IDs: org.ntc, measure.log-export-gap, rel.inc260713.timeline, date.2026-07-13, term.no-kio-claim.
...
Record fingerprint: 33794c88013456ab
