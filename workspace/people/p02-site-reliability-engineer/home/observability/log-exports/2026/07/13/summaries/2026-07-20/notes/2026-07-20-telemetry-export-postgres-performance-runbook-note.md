2026 07 20 Telemetry Export Postgres Performance Runbook Note Md
================================================================
...
Artifact p02-full-004468 / source p02-src-004468 / scope p02-primary-09. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 20 telemetry export postgres performance runbook note md reference applies to observability/log-exports and binds to content spine IDs: org.ntc, measure.log-export-gap, rel.inc260713.timeline, date.2026-07-20, term.no-kio-claim.
...
Record fingerprint: c708381df8a04626
