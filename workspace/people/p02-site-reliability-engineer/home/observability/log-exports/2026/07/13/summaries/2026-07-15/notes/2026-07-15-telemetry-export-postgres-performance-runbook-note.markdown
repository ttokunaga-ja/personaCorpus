2026 07 15 Telemetry Export Postgres Performance Runbook Note Markdown
======================================================================
...
Artifact p02-full-011708 / source p02-src-011708 / scope p02-primary-09. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 15 telemetry export postgres performance runbook note markdown reference applies to observability/log-exports and binds to content spine IDs: org.ntc, inc.inc-260713, rel.inc260713.timeline, date.2026-07-15, term.no-kio-claim.
...
Record fingerprint: c79a4a00724e2340
