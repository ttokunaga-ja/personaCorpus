...
Artifact p02-full-009308 / source p02-src-009308 / scope p02-primary-09. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 q3 telemetry export postgres performance runbook note markdown reference applies to observability/log-exports and binds to content spine IDs: org.ntc, inc.inc-260713, rel.inc260713.timeline, period.2026-q3, term.no-kio-claim.
...
Record fingerprint: bd347e1e5176de78
