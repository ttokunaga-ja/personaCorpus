2026 07 15 Telemetry Export Postgres Performance Runbook Note Md
================================================================
...
Artifact p02-full-003868 / source p02-src-003868 / scope p02-primary-09. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 15 telemetry export postgres performance runbook note md reference applies to observability/log-exports and binds to content spine IDs: org.ntc, measure.log-export-gap, rel.inc260713.timeline, date.2026-07-15, term.no-kio-claim.
...
Record fingerprint: 25f3773c0119c6ff
