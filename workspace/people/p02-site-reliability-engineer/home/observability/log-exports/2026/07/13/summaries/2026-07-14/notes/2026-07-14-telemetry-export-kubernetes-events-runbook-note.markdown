2026 07 14 Telemetry Export Kubernetes Events Runbook Note Markdown
===================================================================
...
Artifact p02-full-014709 / source p02-src-014709 / scope p02-primary-09. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 14 telemetry export kubernetes events runbook note markdown reference applies to observability/log-exports and binds to content spine IDs: org.ntc, svc.telemetry.svc31, rel.inc260713.timeline, date.2026-07-14, term.no-kio-claim.
...
Record fingerprint: 05cbbad29c1e27aa
