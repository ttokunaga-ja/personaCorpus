2026 07 13 Telemetry Export Postgres Performance Runbook Note Md
================================================================
...
Artifact p02-full-004868 / source p02-src-004868 / scope p02-primary-09. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 13 telemetry export postgres performance runbook note md reference applies to observability/log-exports and binds to content spine IDs: org.ntc, inc.inc-260713, rel.inc260713.timeline, date.2026-07-13, term.no-kio-claim.
...
Record fingerprint: 34e3660f4c596c81
