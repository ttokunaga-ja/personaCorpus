2026 07 14 Telemetry Export Export Retry Runbook Note Markdown
==============================================================
...
Artifact p02-full-013207 / source p02-src-013207 / scope p02-primary-09. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 14 telemetry export export retry runbook note markdown reference applies to observability/log-exports and binds to content spine IDs: org.ntc, measure.log-export-gap, rel.inc260713.timeline, date.2026-07-14, term.no-kio-claim.
...
Record fingerprint: 764b764cab980cf0
