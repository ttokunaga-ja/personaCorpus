...
Artifact p02-full-005427 / source p02-src-005427 / scope p02-primary-09. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 13 telemetry export regional ingress runbook note markdown reference applies to observability/log-exports and binds to content spine IDs: org.ntc, svc.telemetry.svc31, rel.inc260713.timeline, date.2026-07-13, term.no-kio-claim.
...
Record fingerprint: 6532a99dd6cb4e37
