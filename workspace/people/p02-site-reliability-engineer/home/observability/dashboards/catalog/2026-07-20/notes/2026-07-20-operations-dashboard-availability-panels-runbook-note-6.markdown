...
Artifact p02-full-007826 / source p02-src-007826 / scope p02-primary-08. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 20 operations dashboard availability panels runbook note markdown reference applies to observability/dashboards and binds to content spine IDs: org.ntc, slo.telemetry.delivery, rel.slo.2026-q3, date.2026-07-20, term.no-kio-claim.
...
Record fingerprint: ba18db67a633b1e8
