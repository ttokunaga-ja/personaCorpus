...
Artifact p02-full-005826 / source p02-src-005826 / scope p02-primary-08. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 15 operations dashboard availability panels runbook note markdown reference applies to observability/dashboards and binds to content spine IDs: org.ntc, budget.checkout.2026-07, rel.slo.2026-q3, date.2026-07-15, term.no-kio-claim.
...
Record fingerprint: f76c31655d4dcba8
