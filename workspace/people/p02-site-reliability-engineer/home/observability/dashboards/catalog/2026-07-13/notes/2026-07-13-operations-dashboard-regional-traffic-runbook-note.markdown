2026 07 13 Operations Dashboard Regional Traffic Runbook Note Markdown
======================================================================
...
Artifact p02-full-014108 / source p02-src-014108 / scope p02-primary-08. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 13 operations dashboard regional traffic runbook note markdown reference applies to observability/dashboards and binds to content spine IDs: org.ntc, slo.telemetry.delivery, rel.slo.2026-q3, date.2026-07-13, term.no-kio-claim.
...
Record fingerprint: d3c1e55a866ca4c2
