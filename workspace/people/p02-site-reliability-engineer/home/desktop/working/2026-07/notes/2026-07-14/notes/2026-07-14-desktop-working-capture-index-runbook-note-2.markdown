2026 07 14 Desktop Working Capture Index Runbook Note Markdown
==============================================================
...
Artifact p02-full-014293 / source p02-src-014293 / scope p02-secondary-01. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 14 desktop working capture index runbook note markdown reference applies to desktop/working and binds to content spine IDs: org.ntc, term.evidence-chain, rel.oncall.2026-07-13, date.2026-07-14, term.no-kio-claim.
...
Record fingerprint: c7f36e28add34fb8
