...
Artifact p02-full-010893 / source p02-src-010893 / scope p02-secondary-01. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 14 desktop working capture index runbook note markdown reference applies to desktop/working and binds to content spine IDs: org.ntc, inc.inc-260713, rel.oncall.2026-07-13, date.2026-07-14, term.no-kio-claim.
...
Record fingerprint: 71c239a148f619d3
