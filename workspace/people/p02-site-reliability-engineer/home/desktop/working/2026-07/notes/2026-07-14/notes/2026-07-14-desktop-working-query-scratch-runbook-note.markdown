2026 07 14 Desktop Working Query Scratch Runbook Note Markdown
==============================================================
...
Artifact p02-full-002358 / source p02-src-002358 / scope p02-secondary-01. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 14 desktop working query scratch runbook note markdown reference applies to desktop/working and binds to content spine IDs: org.ntc, inc.inc-260713, rel.oncall.2026-07-13, date.2026-07-14, term.no-kio-claim.
...
Record fingerprint: 2501b5a6f3850e1b
