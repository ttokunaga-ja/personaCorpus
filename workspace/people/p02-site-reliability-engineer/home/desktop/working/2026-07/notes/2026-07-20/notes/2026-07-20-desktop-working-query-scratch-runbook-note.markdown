2026 07 20 Desktop Working Query Scratch Runbook Note Markdown
==============================================================
...
Artifact p02-full-002406 / source p02-src-002406 / scope p02-secondary-01. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 20 desktop working query scratch runbook note markdown reference applies to desktop/working and binds to content spine IDs: org.ntc, inc.inc-260713, rel.oncall.2026-07-13, date.2026-07-20, term.no-kio-claim.
...
Record fingerprint: 52b7a31faee791eb
