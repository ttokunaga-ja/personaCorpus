2026 Q3 Desktop Working Capture Index Runbook Note Markdown
===========================================================
...
Artifact p02-full-011893 / source p02-src-011893 / scope p02-secondary-01. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 q3 desktop working capture index runbook note markdown reference applies to desktop/working and binds to content spine IDs: org.ntc, term.evidence-chain, rel.oncall.2026-07-13, period.2026-q3, term.no-kio-claim.
...
Record fingerprint: fcb691e06931603b
