...
Artifact p02-full-010761 / source p02-src-010761 / scope p02-primary-11. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 15 capacity plan identity capacity runbook note md reference applies to capacity/reports and binds to content spine IDs: org.ntc, measure.capacity.headroom, rel.capacity.2026-q3, date.2026-07-15, term.no-kio-claim.
...
Record fingerprint: 989c874cd8041f7a
