...
Artifact p02-full-006495 / source p02-src-006495 / scope p02-primary-04. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 15 terraform platform maintenance window runbook note markdown reference applies to infrastructure/terraform and binds to content spine IDs: org.ntc, change.chg-260713-042, rel.change.260713, date.2026-07-15, term.no-kio-claim.
...
Record fingerprint: 38899128c425ca47
