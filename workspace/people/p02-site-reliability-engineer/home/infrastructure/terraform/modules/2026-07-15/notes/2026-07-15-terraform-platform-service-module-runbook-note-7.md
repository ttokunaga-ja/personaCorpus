...
Artifact p02-full-014504 / source p02-src-014504 / scope p02-primary-04. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 15 terraform platform service module runbook note md reference applies to infrastructure/terraform and binds to content spine IDs: org.ntc, env.prod, rel.change.260713, date.2026-07-15, term.no-kio-claim.
...
Record fingerprint: 192436cc63a692ca
