2026 07 13 Terraform Platform Maintenance Window Runbook Note Md
================================================================
...
Artifact p02-full-000911 / source p02-src-000911 / scope p02-primary-04. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 13 terraform platform maintenance window runbook note md reference applies to infrastructure/terraform and binds to content spine IDs: org.ntc, env.prod, rel.change.260713, date.2026-07-13, term.no-kio-claim.
...
Record fingerprint: dbc4dfb264784fa1
