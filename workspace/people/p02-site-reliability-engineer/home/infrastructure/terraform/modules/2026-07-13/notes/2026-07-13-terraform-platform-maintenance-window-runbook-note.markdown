...
Artifact p02-full-005495 / source p02-src-005495 / scope p02-primary-04. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 13 terraform platform maintenance window runbook note markdown reference applies to infrastructure/terraform and binds to content spine IDs: org.ntc, env.prod, rel.change.260713, date.2026-07-13, term.no-kio-claim.
...
Record fingerprint: cea79d4f74042481
