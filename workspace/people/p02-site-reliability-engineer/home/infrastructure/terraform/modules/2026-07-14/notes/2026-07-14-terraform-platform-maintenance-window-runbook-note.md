2026 07 14 Terraform Platform Maintenance Window Runbook Note Md
================================================================
...
Artifact p02-full-000847 / source p02-src-000847 / scope p02-primary-04. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 14 terraform platform maintenance window runbook note md reference applies to infrastructure/terraform and binds to content spine IDs: org.ntc, deploy.dep-260713-017, rel.change.260713, date.2026-07-14, term.no-kio-claim.
...
Record fingerprint: 250996c1fe560b67
