...
Artifact p02-full-009143 / source p02-src-009143 / scope p02-primary-04. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 14 terraform platform maintenance window runbook note markdown reference applies to infrastructure/terraform and binds to content spine IDs: org.ntc, env.prod, rel.change.260713, date.2026-07-14, term.no-kio-claim.
...
Record fingerprint: 3ee641afba10aee8
