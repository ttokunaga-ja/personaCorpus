2026 07 20 Terraform Platform Maintenance Window Runbook Note Markdown
======================================================================
...
Artifact p02-full-008143 / source p02-src-008143 / scope p02-primary-04. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 20 terraform platform maintenance window runbook note markdown reference applies to infrastructure/terraform and binds to content spine IDs: org.ntc, deploy.dep-260713-017, rel.change.260713, date.2026-07-20, term.no-kio-claim.
...
Record fingerprint: 59e5c0831b608eea
