...
Artifact p02-full-006506 / source p02-src-006506 / scope p02-primary-04. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 q3 terraform platform dns failover runbook note markdown reference applies to infrastructure/terraform and binds to content spine IDs: org.ntc, env.prod, rel.change.260713, period.2026-q3, term.no-kio-claim.
...
Record fingerprint: 949940cd6f4dcb1f
