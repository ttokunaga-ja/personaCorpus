...
Artifact p02-full-001044 / source p02-src-001044 / scope p02-primary-04. Synthetic training record; no customer data, credentials, secrets, or Kio claims.
...
Record fingerprint: b7a5437df226f7f1
