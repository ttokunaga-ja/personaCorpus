...
Artifact p02-full-000761 / source p02-src-000761 / scope p02-primary-03. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 20 kubernetes production service routing runbook note md reference applies to infrastructure/kubernetes and binds to content spine IDs: org.ntc, env.prod, rel.topology.260713, date.2026-07-20, term.no-kio-claim.
...
Record fingerprint: 0b70cadee3a5d7f9
