2026 07 13 Kubernetes Production Telemetry Exporter Runbook Note Md
===================================================================
...
Artifact p02-full-003255 / source p02-src-003255 / scope p02-primary-03. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 13 kubernetes production telemetry exporter runbook note md reference applies to infrastructure/kubernetes and binds to content spine IDs: org.ntc, svc.checkout.svc17, rel.topology.260713, date.2026-07-13, term.no-kio-claim.
...
Record fingerprint: 140c4bf88b057f1c
