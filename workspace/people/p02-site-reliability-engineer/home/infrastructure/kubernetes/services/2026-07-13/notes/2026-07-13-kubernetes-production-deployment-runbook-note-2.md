...
Artifact p02-full-000704 / source p02-src-000704 / scope p02-primary-03. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 13 kubernetes production deployment runbook note md reference applies to infrastructure/kubernetes and binds to content spine IDs: org.ntc, env.prod, rel.topology.260713, date.2026-07-13, term.no-kio-claim.
...
Record fingerprint: 13bb4e132bfcf94a
