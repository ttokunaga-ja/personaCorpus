...
Artifact p02-full-005194 / source p02-src-005194 / scope p02-primary-03. Synthetic training record; no customer data, credentials, secrets, or Kio claims.
...
Record fingerprint: e4bacf9f7ff58e0c
