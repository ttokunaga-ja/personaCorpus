...
Artifact p02-full-008032 / source p02-src-008032 / scope p02-primary-03. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 15 kubernetes production deployment runbook note md reference applies to infrastructure/kubernetes and binds to content spine IDs: org.ntc, svc.identity.svc23, rel.topology.260713, date.2026-07-15, term.no-kio-claim.
...
Record fingerprint: b9b12c6f082be836
