...
Artifact p02-full-011494 / source p02-src-011494 / scope p02-primary-03. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 15 kubernetes production priority class runbook note markdown reference applies to infrastructure/kubernetes and binds to content spine IDs: org.ntc, svc.identity.svc23, rel.topology.260713, date.2026-07-15, term.no-kio-claim.
...
Record fingerprint: 523225664cc1339a
