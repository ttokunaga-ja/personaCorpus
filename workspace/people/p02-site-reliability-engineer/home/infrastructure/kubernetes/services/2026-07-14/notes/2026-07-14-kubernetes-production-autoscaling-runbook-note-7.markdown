...
Artifact p02-full-011594 / source p02-src-011594 / scope p02-primary-03. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 14 kubernetes production autoscaling runbook note markdown reference applies to infrastructure/kubernetes and binds to content spine IDs: org.ntc, env.prod, rel.topology.260713, date.2026-07-14, term.no-kio-claim.
...
Record fingerprint: 9d86fd64c4160e4c
