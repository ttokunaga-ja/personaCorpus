...
Artifact p02-full-001226 / source p02-src-001226 / scope p02-primary-05. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 13 checkout oncall database failover runbook note markdown reference applies to services/checkout/prod/oncall/operations and binds to content spine IDs: org.ntc, dep.payments.q07, rel.oncall.2026-07-13, date.2026-07-13, term.no-kio-claim.
...
Record fingerprint: f60f627fd9d031c2
