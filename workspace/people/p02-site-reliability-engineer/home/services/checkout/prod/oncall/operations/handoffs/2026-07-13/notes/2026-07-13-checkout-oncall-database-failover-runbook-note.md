...
Artifact p02-full-001090 / source p02-src-001090 / scope p02-primary-05. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 13 checkout oncall database failover runbook note md reference applies to services/checkout/prod/oncall/operations and binds to content spine IDs: org.ntc, inc.inc-260713, rel.oncall.2026-07-13, date.2026-07-13, term.no-kio-claim.
...
Record fingerprint: ff68ba55a157114f
