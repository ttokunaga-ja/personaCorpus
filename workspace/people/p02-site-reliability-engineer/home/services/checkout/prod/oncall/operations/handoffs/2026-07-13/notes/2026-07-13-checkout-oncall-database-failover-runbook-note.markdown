2026 07 13 Checkout Oncall Database Failover Runbook Note Markdown
==================================================================
...
Artifact p02-full-001194 / source p02-src-001194 / scope p02-primary-05. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 13 checkout oncall database failover runbook note markdown reference applies to services/checkout/prod/oncall/operations and binds to content spine IDs: org.ntc, svc.checkout.svc17, rel.oncall.2026-07-13, date.2026-07-13, term.no-kio-claim.
...
Record fingerprint: 6c5ad7bcd0ff9a79
