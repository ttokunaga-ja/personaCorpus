...
Artifact p02-full-001276 / source p02-src-001276 / scope p02-primary-05. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 15 checkout oncall cache recovery runbook note markdown reference applies to services/checkout/prod/oncall/operations and binds to content spine IDs: org.ntc, inc.inc-260713, rel.oncall.2026-07-13, date.2026-07-15, term.no-kio-claim.
...
Record fingerprint: 113ab5cd5f678d2a
