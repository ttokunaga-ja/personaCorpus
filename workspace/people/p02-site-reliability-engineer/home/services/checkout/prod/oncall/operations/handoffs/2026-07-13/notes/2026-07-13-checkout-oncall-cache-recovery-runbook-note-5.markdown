...
Artifact p02-full-010396 / source p02-src-010396 / scope p02-primary-05. Synthetic training record; no customer data, credentials, secrets, or Kio claims.
...
Record fingerprint: 4dcd8602d3a1135e
