2026 07 13 Identity Oncall Token Validation Runbook Note Markdown
=================================================================
...
Artifact p02-full-008544 / source p02-src-008544 / scope p02-primary-06. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 13 identity oncall token validation runbook note markdown reference applies to services/identity/prod/oncall/operations and binds to content spine IDs: org.ntc, svc.identity.svc23, rel.oncall.2026-07-13, date.2026-07-13, term.no-kio-claim.
...
Record fingerprint: 04f2d760745a830f
