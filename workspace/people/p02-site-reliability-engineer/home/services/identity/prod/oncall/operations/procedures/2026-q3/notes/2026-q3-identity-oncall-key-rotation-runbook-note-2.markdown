...
Artifact p02-full-013194 / source p02-src-013194 / scope p02-primary-06. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 q3 identity oncall key rotation runbook note markdown reference applies to services/identity/prod/oncall/operations and binds to content spine IDs: org.ntc, svc.identity.svc23, rel.oncall.2026-07-13, period.2026-q3, term.no-kio-claim.
...
Record fingerprint: f5e46b19dec93671
