2026 Q3 Identity Oncall Cache Flush Runbook Note Markdown
=========================================================
...
Artifact p02-full-014558 / source p02-src-014558 / scope p02-primary-06. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 q3 identity oncall cache flush runbook note markdown reference applies to services/identity/prod/oncall/operations and binds to content spine IDs: org.ntc, measure.identity.p95-high, rel.oncall.2026-07-13, period.2026-q3, term.no-kio-claim.
...
Record fingerprint: 375d30a7f020df62
