2026 07 20 Identity Oncall Rate Limit Runbook Note Markdown
===========================================================
...
Artifact p02-full-013427 / source p02-src-013427 / scope p02-primary-06. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 20 identity oncall rate limit runbook note markdown reference applies to services/identity/prod/oncall/operations and binds to content spine IDs: org.ntc, measure.identity.p95-high, rel.oncall.2026-07-13, date.2026-07-20, term.no-kio-claim.
...
Record fingerprint: 61a156a06f1be157
