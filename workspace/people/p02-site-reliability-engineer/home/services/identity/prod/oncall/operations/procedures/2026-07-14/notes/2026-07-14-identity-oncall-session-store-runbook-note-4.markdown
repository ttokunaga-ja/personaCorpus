2026 07 14 Identity Oncall Session Store Runbook Note Markdown
==============================================================
...
Artifact p02-full-010577 / source p02-src-010577 / scope p02-primary-06. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 14 identity oncall session store runbook note markdown reference applies to services/identity/prod/oncall/operations and binds to content spine IDs: org.ntc, measure.identity.p95-high, rel.oncall.2026-07-13, date.2026-07-14, term.no-kio-claim.
...
Record fingerprint: 10276d6a01d0b54f
