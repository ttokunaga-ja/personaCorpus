2026 07 20 Identity Oncall Key Rotation Runbook Note Markdown
=============================================================
...
Artifact p02-full-012242 / source p02-src-012242 / scope p02-primary-06. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 20 identity oncall key rotation runbook note markdown reference applies to services/identity/prod/oncall/operations and binds to content spine IDs: org.ntc, measure.identity.p95-high, rel.oncall.2026-07-13, date.2026-07-20, term.no-kio-claim.
...
Record fingerprint: 8a5535f51a6b432d
