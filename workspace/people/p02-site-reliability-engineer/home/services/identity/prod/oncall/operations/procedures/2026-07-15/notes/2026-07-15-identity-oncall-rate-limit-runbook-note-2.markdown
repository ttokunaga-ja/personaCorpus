2026 07 15 Identity Oncall Rate Limit Runbook Note Markdown
===========================================================
...
Artifact p02-full-011427 / source p02-src-011427 / scope p02-primary-06. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 15 identity oncall rate limit runbook note markdown reference applies to services/identity/prod/oncall/operations and binds to content spine IDs: org.ntc, svc.identity.svc23, rel.oncall.2026-07-13, date.2026-07-15, term.no-kio-claim.
...
Record fingerprint: ec30081e5b49490f
