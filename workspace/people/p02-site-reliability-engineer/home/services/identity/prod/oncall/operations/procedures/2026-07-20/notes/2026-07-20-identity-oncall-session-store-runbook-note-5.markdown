...
Artifact p02-full-009577 / source p02-src-009577 / scope p02-primary-06. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 20 identity oncall session store runbook note markdown reference applies to services/identity/prod/oncall/operations and binds to content spine IDs: org.ntc, inc.inc-260713, rel.oncall.2026-07-13, date.2026-07-20, term.no-kio-claim.
...
Record fingerprint: 97a2e42bcfc85cc0
