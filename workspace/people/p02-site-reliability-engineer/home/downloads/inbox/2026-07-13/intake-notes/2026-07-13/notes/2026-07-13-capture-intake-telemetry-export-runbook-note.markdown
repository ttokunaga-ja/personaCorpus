2026 07 13 Capture Intake Telemetry Export Runbook Note Markdown
================================================================
...
Artifact p02-full-008893 / source p02-src-008893 / scope p02-secondary-03. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 13 capture intake telemetry export runbook note markdown reference applies to downloads/inbox and binds to content spine IDs: org.ntc, dep.payments.q07, rel.archive.closed, date.2026-07-13, term.no-kio-claim.
...
Record fingerprint: 6f26948aad414f2d
