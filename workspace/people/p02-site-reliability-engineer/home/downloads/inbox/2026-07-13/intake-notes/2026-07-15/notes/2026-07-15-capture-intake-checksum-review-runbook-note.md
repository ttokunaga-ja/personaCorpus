...
Artifact p02-full-009990 / source p02-src-009990 / scope p02-secondary-03. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 15 capture intake checksum review runbook note md reference applies to downloads/inbox and binds to content spine IDs: org.ntc, inc.inc-260713, rel.archive.closed, date.2026-07-15, term.no-kio-claim.
...
Record fingerprint: 8613f48455441786
