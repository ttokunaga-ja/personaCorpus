...
Artifact p02-full-007740 / source p02-src-007740 / scope p02-secondary-03. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 13 capture intake regional ingress runbook note md reference applies to downloads/inbox and binds to content spine IDs: org.ntc, inc.inc-260713, rel.archive.closed, date.2026-07-13, term.no-kio-claim.
...
Record fingerprint: fcaf2cab57da571e
