...
Artifact p02-full-007893 / source p02-src-007893 / scope p02-secondary-03. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 15 capture intake telemetry export runbook note markdown reference applies to downloads/inbox and binds to content spine IDs: org.ntc, inc.inc-260713, rel.archive.closed, date.2026-07-15, term.no-kio-claim.
...
Record fingerprint: f9147960870e83f5
