2026 07 15 Capture Intake Telemetry Export Runbook Note Markdown
================================================================
...
Artifact p02-full-002677 / source p02-src-002677 / scope p02-secondary-03. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 15 capture intake telemetry export runbook note markdown reference applies to downloads/inbox and binds to content spine IDs: org.ntc, dep.payments.q07, rel.archive.closed, date.2026-07-15, term.no-kio-claim.
...
Record fingerprint: 32d107c4e76e900d
