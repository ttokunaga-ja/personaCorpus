2026 07 14 Capture Intake Telemetry Export Runbook Note Markdown
================================================================
...
Artifact p02-full-008693 / source p02-src-008693 / scope p02-secondary-03. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 14 capture intake telemetry export runbook note markdown reference applies to downloads/inbox and binds to content spine IDs: org.ntc, term.evidence-chain, rel.archive.closed, date.2026-07-14, term.no-kio-claim.
...
Record fingerprint: 3c0590df5b93ed8a
