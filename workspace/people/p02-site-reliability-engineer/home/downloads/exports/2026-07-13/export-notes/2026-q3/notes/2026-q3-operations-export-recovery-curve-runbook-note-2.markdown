2026 Q3 Operations Export Recovery Curve Runbook Note Markdown
==============================================================
...
Artifact p02-full-003358 / source p02-src-003358 / scope p02-secondary-04. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 q3 operations export recovery curve runbook note markdown reference applies to downloads/exports and binds to content spine IDs: org.ntc, measure.queue.depth-high, rel.topology.260713, period.2026-q3, term.no-kio-claim.
...
Record fingerprint: 9d3748989bd32c09
