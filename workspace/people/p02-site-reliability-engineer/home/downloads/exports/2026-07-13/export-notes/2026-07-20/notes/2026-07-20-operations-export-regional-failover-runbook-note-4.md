2026 07 20 Operations Export Regional Failover Runbook Note Md
==============================================================
...
Artifact p02-full-011083 / source p02-src-011083 / scope p02-secondary-04. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 20 operations export regional failover runbook note md reference applies to downloads/exports and binds to content spine IDs: org.ntc, measure.queue.depth-high, rel.topology.260713, date.2026-07-20, term.no-kio-claim.
...
Record fingerprint: 6cfd115398bab275
