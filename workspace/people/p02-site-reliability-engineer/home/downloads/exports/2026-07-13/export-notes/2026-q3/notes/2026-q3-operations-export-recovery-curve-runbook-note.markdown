...
Artifact p02-full-002726 / source p02-src-002726 / scope p02-secondary-04. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 q3 operations export recovery curve runbook note markdown reference applies to downloads/exports and binds to content spine IDs: org.ntc, env.prod, rel.topology.260713, period.2026-q3, term.no-kio-claim.
...
Record fingerprint: 46931c4916522dca
