2026 07 20 Operations Export Recovery Curve Runbook Note Md
===========================================================
...
Artifact p02-full-002790 / source p02-src-002790 / scope p02-secondary-04. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 20 operations export recovery curve runbook note md reference applies to downloads/exports and binds to content spine IDs: org.ntc, measure.burn-rate-short, rel.topology.260713, date.2026-07-20, term.no-kio-claim.
...
Record fingerprint: 0ec739883238c857
