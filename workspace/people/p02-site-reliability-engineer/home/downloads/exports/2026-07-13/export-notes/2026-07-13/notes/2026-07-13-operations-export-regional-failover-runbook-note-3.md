2026 07 13 Operations Export Regional Failover Runbook Note Md
==============================================================
...
Artifact p02-full-012883 / source p02-src-012883 / scope p02-secondary-04. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 13 operations export regional failover runbook note md reference applies to downloads/exports and binds to content spine IDs: org.ntc, measure.queue.depth-high, rel.topology.260713, date.2026-07-13, term.no-kio-claim.
...
Record fingerprint: 22663acbefb222be
