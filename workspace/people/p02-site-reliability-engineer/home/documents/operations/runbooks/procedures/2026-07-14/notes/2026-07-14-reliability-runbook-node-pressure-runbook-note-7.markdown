...
Artifact p02-full-011876 / source p02-src-011876 / scope p02-primary-01. Synthetic training record; no customer data, credentials, secrets, or Kio claims.
...
Record fingerprint: bd9984f846ca94c2
