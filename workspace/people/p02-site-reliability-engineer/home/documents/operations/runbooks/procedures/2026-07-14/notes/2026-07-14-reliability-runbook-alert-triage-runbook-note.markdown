2026 07 14 Reliability Runbook Alert Triage Runbook Note Markdown
=================================================================
...
Artifact p02-full-000293 / source p02-src-000293 / scope p02-primary-01. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 14 reliability runbook alert triage runbook note markdown reference applies to documents/operations/runbooks and binds to content spine IDs: org.ntc, term.mitigation, rel.inc260713.timeline, date.2026-07-14, term.no-kio-claim.
...
Record fingerprint: 30505435ad74b75c
