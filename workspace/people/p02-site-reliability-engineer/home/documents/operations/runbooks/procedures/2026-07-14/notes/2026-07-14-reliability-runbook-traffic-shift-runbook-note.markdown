...
Artifact p02-full-005858 / source p02-src-005858 / scope p02-primary-01. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 14 reliability runbook traffic shift runbook note markdown reference applies to documents/operations/runbooks and binds to content spine IDs: org.ntc, term.mitigation, rel.inc260713.timeline, date.2026-07-14, term.no-kio-claim.
...
Record fingerprint: 9920ed3b5b6df462
