...
Rollback-ready means a tested reversal path, a scope-local evidence location, an accountable owner role, and an explicit stop condition. Evidence review order: DEP 09:18 -> Q-07 warning 09:42 -> rate limit 09:54 -> recovery 10:24 -> impact end 10:31 -> concurrency 10:11 -> rollback approval 10:02 -> reconciliation 11:06 -> S2 09:47 -> resolution 10:42.
Artifact p02-full-007618 / source p02-src-007618 / scope p02-primary-01. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 20 reliability runbook traffic shift runbook note md reference applies to documents/operations/runbooks and binds to content spine IDs: org.ntc, svc.identity.svc23, rel.inc260713.timeline, date.2026-07-20, term.no-kio-claim.
...
Record fingerprint: c12001b096b78bea
