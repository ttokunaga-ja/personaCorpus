...
Artifact p02-full-007457 / source p02-src-007457 / scope p02-primary-01. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 13 reliability runbook database failover runbook note markdown reference applies to documents/operations/runbooks and binds to content spine IDs: org.ntc, term.mitigation, rel.inc260713.timeline, date.2026-07-13, term.no-kio-claim.
...
Record fingerprint: 89a8249665306f93
