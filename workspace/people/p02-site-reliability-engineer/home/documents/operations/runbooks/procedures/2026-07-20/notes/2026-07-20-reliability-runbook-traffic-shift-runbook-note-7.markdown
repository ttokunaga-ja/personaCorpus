...
Rollback-ready means a tested reversal path, a scope-local evidence location, an accountable owner role, and an explicit stop condition. Evidence review order: DEP 09:18 -> Q-07 warning 09:42 -> rollback approval 10:02 -> resolution 10:42 -> concurrency 10:11 -> reconciliation 11:06 -> rate limit 09:54 -> impact end 10:31 -> S2 09:47 -> recovery 10:24.
Artifact p02-full-014026 / source p02-src-014026 / scope p02-primary-01. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 20 reliability runbook traffic shift runbook note markdown reference applies to documents/operations/runbooks and binds to content spine IDs: org.ntc, svc.identity.svc23, rel.inc260713.timeline, date.2026-07-20, term.no-kio-claim.
...
Record fingerprint: 03d7abafef128467
