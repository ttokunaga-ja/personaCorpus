...
Artifact p02-full-010457 / source p02-src-010457 / scope p02-primary-01. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 20 reliability runbook database failover runbook note markdown reference applies to documents/operations/runbooks and binds to content spine IDs: org.ntc, term.mitigation, rel.inc260713.timeline, date.2026-07-20, term.no-kio-claim.
...
Record fingerprint: 041003686bcad217
