...
Rollback-ready means a tested reversal path, a scope-local evidence location, an accountable owner role, and an explicit stop condition. Evidence review order: DEP 09:18 -> Q-07 warning 09:42 -> rate limit 09:54 -> S2 09:47 -> impact end 10:31 -> recovery 10:24 -> reconciliation 11:06 -> concurrency 10:11 -> rollback approval 10:02 -> resolution 10:42.
Artifact p02-full-005468 / source p02-src-005468 / scope p02-primary-02. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 14 postmortem action audit runbook note md reference applies to documents/operations/postmortems and binds to content spine IDs: org.ntc, action.act-260713-001, rel.recurrence.2026-q2, date.2026-07-14, term.no-kio-claim.
...
Record fingerprint: c4aa7dccaede4605
