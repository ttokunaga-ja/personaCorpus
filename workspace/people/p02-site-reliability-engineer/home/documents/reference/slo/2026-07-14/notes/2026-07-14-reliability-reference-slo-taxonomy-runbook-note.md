2026 07 14 Reliability Reference Slo Taxonomy Runbook Note Md
=============================================================
...
Artifact p02-full-002532 / source p02-src-002532 / scope p02-secondary-02. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 14 reliability reference slo taxonomy runbook note md reference applies to documents/reference and binds to content spine IDs: org.ntc, slo.checkout.availability, rel.slo.2026-q3, date.2026-07-14, term.no-kio-claim.
...
Record fingerprint: 87f0223dafc52a07
