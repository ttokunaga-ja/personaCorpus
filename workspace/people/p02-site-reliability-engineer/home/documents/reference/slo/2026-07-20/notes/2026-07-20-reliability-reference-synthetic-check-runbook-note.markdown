2026 07 20 Reliability Reference Synthetic Check Runbook Note Markdown
======================================================================
...
Artifact p02-full-002577 / source p02-src-002577 / scope p02-secondary-02. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 20 reliability reference synthetic check runbook note markdown reference applies to documents/reference and binds to content spine IDs: org.ntc, slo.checkout.availability, rel.slo.2026-q3, date.2026-07-20, term.no-kio-claim.
...
Record fingerprint: 9f5910207e836318
