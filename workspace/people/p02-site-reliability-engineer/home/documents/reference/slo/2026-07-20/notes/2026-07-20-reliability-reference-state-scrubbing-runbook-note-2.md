...
Artifact p02-full-002547 / source p02-src-002547 / scope p02-secondary-02. Synthetic training record; no customer data, credentials, secrets, or Kio claims.

## Purpose
This 2026 07 20 reliability reference state scrubbing runbook note md reference applies to documents/reference and binds to content spine IDs: org.ntc, slo.checkout.availability, rel.slo.2026-q3, date.2026-07-20, term.no-kio-claim.
...
Record fingerprint: e9e814eada4f6be6
