# Product Alpha R7 Rollback Drill — p01-full-001263

## Purpose

This repository reference documents `svc-event-bus` for synthetic Aster Loop Product Alpha R7. It gives focused engineering guidance for rollback drill and contains no customer environment data.
...
| Repository reference | p01-src-001263 |
