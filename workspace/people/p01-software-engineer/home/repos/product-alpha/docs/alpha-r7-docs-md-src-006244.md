# Product Alpha R7 repository evidence: p01-full-006244
...
Source `p01-src-006244` records a repository-local operational explanation. The 2026-07-17 controlled rollback drill recovered in 702 seconds; it is not an incident record.
