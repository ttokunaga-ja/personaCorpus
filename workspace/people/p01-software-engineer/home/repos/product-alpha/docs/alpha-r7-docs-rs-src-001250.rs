/// Synthetic Product Alpha R7 documentation helper for release gate behavior.
pub const ARTIFACT_ID: &str = "p01-full-001250";
pub const SERVICE: &str = "svc-decision-store";
