/// Synthetic Product Alpha R7 documentation helper for rollback drill.
pub const ARTIFACT_ID: &str = "p01-full-001271";
pub const SERVICE: &str = "svc-contract-registry";
