# Product Alpha R7 repository evidence: p01-full-008758
...
Source `p01-src-008758` records a repository-local operational explanation. The 2026-07-17 controlled rollback drill recovered in 702 seconds; it is not an incident record.
