# Product Alpha R7 Event Delivery — p01-full-001236

## Purpose

This repository reference documents `svc-edge-api` for synthetic Aster Loop Product Alpha R7. It gives focused engineering guidance for event delivery and contains no customer environment data.
...
| Repository reference | p01-src-001236 |
