# Product Alpha R7 Runbook Navigation — p01-full-004016

## Purpose

This repository reference documents `svc-decision-store` for synthetic Aster Loop Product Alpha R7. It gives focused engineering guidance for runbook navigation and contains no customer environment data.
...
| Repository reference | p01-src-004016 |
