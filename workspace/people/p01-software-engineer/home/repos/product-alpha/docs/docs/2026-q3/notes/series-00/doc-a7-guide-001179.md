# Product Alpha R7 Decision Durability — p01-full-001179

## Purpose

This repository reference documents `svc-event-bus` for synthetic Aster Loop Product Alpha R7. It gives focused engineering guidance for decision durability and contains no customer environment data.
...
| Repository reference | p01-src-001179 |
