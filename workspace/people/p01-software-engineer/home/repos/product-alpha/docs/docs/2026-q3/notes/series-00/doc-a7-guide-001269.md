# Product Alpha R7 Evidence Capture — p01-full-001269

## Purpose

This repository reference documents `svc-event-bus` for synthetic Aster Loop Product Alpha R7. It gives focused engineering guidance for evidence capture and contains no customer environment data.
...
| Repository reference | p01-src-001269 |
