# CR-A7-004783: decision audit retention
...
This synthetic review covers 27 changed files in `synthetic-0012af`. The review checks decision audit retention without treating a release gate as an authentication boundary.
