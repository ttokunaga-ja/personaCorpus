/** Synthetic lifecycle contract for p01-src-006587. */
...
export const lifecycle: DecisionLifecycle = {
  recordId: "p01-src-006587", adrId: "ADR-021", product: "Product Alpha R7", service: "svc-contract-registry", state: "approved",
};
