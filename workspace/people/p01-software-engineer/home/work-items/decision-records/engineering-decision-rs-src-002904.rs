//! Synthetic decision lifecycle rule for p01-src-002904.
#[derive(Debug, Clone, Copy)]
struct DecisionRecord { record_id: &'static str, adr_id: &'static str, ceiling_ms: u16 }

const RECORD: DecisionRecord = DecisionRecord { record_id: "p01-src-002904", adr_id: "ADR-B4-119", ceiling_ms: 200 };
...
fn main() {
    println!("{} {} {}", RECORD.record_id, RECORD.adr_id, accepted(RECORD, 184, "closed"));
}
