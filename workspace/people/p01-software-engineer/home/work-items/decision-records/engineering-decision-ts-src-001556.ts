/** Synthetic decision lifecycle contract for p01-src-001556. */
...
export const decision: DecisionRecord = {
  recordId: "p01-src-001556", adrId: "ADR-164", product: "Product Alpha R7", status: "reviewed", service: "svc-decision-store",
};
