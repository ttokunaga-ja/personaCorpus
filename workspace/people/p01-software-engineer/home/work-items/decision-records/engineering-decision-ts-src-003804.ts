/** Synthetic decision lifecycle contract for p01-src-003804. */
...
export const decision: DecisionRecord = {
  recordId: "p01-src-003804", adrId: "ADR-B4-024", product: "Product Beta R4", status: "closed", service: "svc-edge-api",
};
