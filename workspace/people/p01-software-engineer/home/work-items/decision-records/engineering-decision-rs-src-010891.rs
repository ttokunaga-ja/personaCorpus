//! Synthetic engineering decision evaluator for p01-src-010891.
#[derive(Debug)]
struct LifecycleDecision { record_id: &'static str, adr_id: &'static str, state: &'static str }

const DECISION: LifecycleDecision = LifecycleDecision { record_id: "p01-src-010891", adr_id: "ADR-146", state: "reviewed" };
