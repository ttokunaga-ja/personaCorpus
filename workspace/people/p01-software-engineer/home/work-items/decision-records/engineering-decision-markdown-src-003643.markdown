# ADR-062: versioned event envelope

- Record: p01-src-003643
...
Adopt the versioned event envelope for svc-release-coordinator. The implementation emits a decision record with the stable identifier ADR-062, a lifecycle status of released, and an auditable rationale. No individual mailbox, credential, or customer identifier is stored in this record.
