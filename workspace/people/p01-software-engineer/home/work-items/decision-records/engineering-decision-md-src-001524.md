# ADR-B4-132: bounded retry budget

- Record: p01-src-001524
...
Adopt the bounded retry budget for svc-edge-api. The implementation emits a decision record with the stable identifier ADR-B4-132, a lifecycle status of closed, and an auditable rationale. No individual mailbox, credential, or customer identifier is stored in this record.
