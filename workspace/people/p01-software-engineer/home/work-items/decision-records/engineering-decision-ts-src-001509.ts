/** Synthetic decision lifecycle contract for p01-src-001509. */
...
export const decision: DecisionRecord = {
  recordId: "p01-src-001509", adrId: "ADR-B4-117", product: "Product Beta R4", status: "closed", service: "svc-event-bus",
};
