/** Synthetic lifecycle contract for p01-src-009505. */
...
export const lifecycle: DecisionLifecycle = {
  recordId: "p01-src-009505", adrId: "ADR-153", product: "Product Alpha R7", service: "svc-release-coordinator", state: "proposed",
};
