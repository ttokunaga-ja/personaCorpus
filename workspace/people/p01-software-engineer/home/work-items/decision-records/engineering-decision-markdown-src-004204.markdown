# ADR-026: idempotency key format

- Record: p01-src-004204
...
Adopt the idempotency key format for svc-observability. The implementation emits a decision record with the stable identifier ADR-026, a lifecycle status of closed, and an auditable rationale. No individual mailbox, credential, or customer identifier is stored in this record.
