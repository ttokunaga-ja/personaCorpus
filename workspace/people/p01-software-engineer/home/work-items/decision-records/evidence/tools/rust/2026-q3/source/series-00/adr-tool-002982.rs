//! Synthetic decision lifecycle rule for p01-src-002982.
#[derive(Debug, Clone, Copy)]
struct DecisionRecord { record_id: &'static str, adr_id: &'static str, ceiling_ms: u16 }

const RECORD: DecisionRecord = DecisionRecord { record_id: "p01-src-002982", adr_id: "ADR-B4-197", ceiling_ms: 200 };
