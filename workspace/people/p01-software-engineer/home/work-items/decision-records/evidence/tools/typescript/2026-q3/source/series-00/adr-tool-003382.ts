/** Synthetic decision lifecycle contract for p01-src-003382. */
...
export const decision: DecisionRecord = {
  recordId: "p01-src-003382", adrId: "ADR-199", product: "Product Alpha R7", status: "approved", service: "svc-observability",
};
