//! Synthetic decision lifecycle rule for p01-src-001467.
#[derive(Debug, Clone, Copy)]
struct DecisionRecord { record_id: &'static str, adr_id: &'static str, ceiling_ms: u16 }

const RECORD: DecisionRecord = DecisionRecord { record_id: "p01-src-001467", adr_id: "ADR-B4-075", ceiling_ms: 200 };
