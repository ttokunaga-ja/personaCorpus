...
Adopt the evidence retention window for svc-decision-store. The implementation emits a decision record with the stable identifier ADR-146, a lifecycle status of released, and an auditable rationale. No individual mailbox, credential, or customer identifier is stored in this record.
