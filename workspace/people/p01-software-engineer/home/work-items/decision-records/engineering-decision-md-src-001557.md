# ADR-B4-165: schema compatibility gate

- Record: p01-src-001557
...
Adopt the schema compatibility gate for svc-event-bus. The implementation emits a decision record with the stable identifier ADR-B4-165, a lifecycle status of approved, and an auditable rationale. No individual mailbox, credential, or customer identifier is stored in this record.
