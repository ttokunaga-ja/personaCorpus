/** Synthetic decision lifecycle contract for p01-src-001468. */
...
export const decision: DecisionRecord = {
  recordId: "p01-src-001468", adrId: "ADR-076", product: "Product Alpha R7", status: "released", service: "svc-observability",
};
