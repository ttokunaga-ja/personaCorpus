# ADR-166: idempotency key format

- Record: p01-src-001558
...
Adopt the idempotency key format for svc-observability. The implementation emits a decision record with the stable identifier ADR-166, a lifecycle status of released, and an auditable rationale. No individual mailbox, credential, or customer identifier is stored in this record.
