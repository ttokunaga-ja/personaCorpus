# ADR-157: versioned event envelope

- Record: p01-src-001549
...
Adopt the versioned event envelope for svc-release-coordinator. The implementation emits a decision record with the stable identifier ADR-157, a lifecycle status of closed, and an auditable rationale. No individual mailbox, credential, or customer identifier is stored in this record.
