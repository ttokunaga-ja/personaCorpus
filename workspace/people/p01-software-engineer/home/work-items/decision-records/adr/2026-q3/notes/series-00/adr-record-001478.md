# ADR-086: evidence retention window

- Record: p01-src-001478
...
Adopt the evidence retention window for svc-decision-store. The implementation emits a decision record with the stable identifier ADR-086, a lifecycle status of released, and an auditable rationale. No individual mailbox, credential, or customer identifier is stored in this record.
