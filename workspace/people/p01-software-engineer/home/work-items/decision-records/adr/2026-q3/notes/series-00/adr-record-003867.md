# ADR-B4-087: schema compatibility gate

- Record: p01-src-003867
...
Adopt the schema compatibility gate for svc-event-bus. The implementation emits a decision record with the stable identifier ADR-B4-087, a lifecycle status of approved, and an auditable rationale. No individual mailbox, credential, or customer identifier is stored in this record.
