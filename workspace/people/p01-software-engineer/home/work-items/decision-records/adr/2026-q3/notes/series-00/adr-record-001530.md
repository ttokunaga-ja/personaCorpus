# ADR-B4-138: bounded retry budget

- Record: p01-src-001530
...
Adopt the bounded retry budget for svc-edge-api. The implementation emits a decision record with the stable identifier ADR-B4-138, a lifecycle status of proposed, and an auditable rationale. No individual mailbox, credential, or customer identifier is stored in this record.
