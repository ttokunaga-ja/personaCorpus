# ADR-064: rollback rehearsal cadence

- Record: p01-src-004043
...
Adopt the rollback rehearsal cadence for svc-contract-registry. The implementation emits a decision record with the stable identifier ADR-064, a lifecycle status of released, and an auditable rationale. No individual mailbox, credential, or customer identifier is stored in this record.
