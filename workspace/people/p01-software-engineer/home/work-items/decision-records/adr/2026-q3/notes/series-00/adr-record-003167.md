# ADR-183: rollback rehearsal cadence

- Record: p01-src-003167
...
Adopt the rollback rehearsal cadence for svc-contract-registry. The implementation emits a decision record with the stable identifier ADR-183, a lifecycle status of approved, and an auditable rationale. No individual mailbox, credential, or customer identifier is stored in this record.
