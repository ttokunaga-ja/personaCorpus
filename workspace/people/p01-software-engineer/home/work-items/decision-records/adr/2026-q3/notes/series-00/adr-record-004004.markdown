# ADR-025: evidence retention window

- Record: p01-src-004004
...
Adopt the evidence retention window for svc-decision-store. The implementation emits a decision record with the stable identifier ADR-025, a lifecycle status of closed, and an auditable rationale. No individual mailbox, credential, or customer identifier is stored in this record.
