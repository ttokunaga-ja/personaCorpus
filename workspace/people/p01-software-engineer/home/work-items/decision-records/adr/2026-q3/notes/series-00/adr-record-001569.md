# ADR-B4-177: schema compatibility gate

- Record: p01-src-001569
...
Adopt the schema compatibility gate for svc-event-bus. The implementation emits a decision record with the stable identifier ADR-B4-177, a lifecycle status of closed, and an auditable rationale. No individual mailbox, credential, or customer identifier is stored in this record.
