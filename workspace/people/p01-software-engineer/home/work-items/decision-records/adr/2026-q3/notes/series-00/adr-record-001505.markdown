# ADR-113: rollback rehearsal cadence

- Record: p01-src-001505
...
Adopt the rollback rehearsal cadence for svc-contract-registry. The implementation emits a decision record with the stable identifier ADR-113, a lifecycle status of proposed, and an auditable rationale. No individual mailbox, credential, or customer identifier is stored in this record.
