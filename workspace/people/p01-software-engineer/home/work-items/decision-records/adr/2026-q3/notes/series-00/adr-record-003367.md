# ADR-184: versioned event envelope

- Record: p01-src-003367
...
Adopt the versioned event envelope for svc-release-coordinator. The implementation emits a decision record with the stable identifier ADR-184, a lifecycle status of approved, and an auditable rationale. No individual mailbox, credential, or customer identifier is stored in this record.
