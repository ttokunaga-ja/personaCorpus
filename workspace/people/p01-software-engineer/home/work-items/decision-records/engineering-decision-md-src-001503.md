# ADR-B4-111: schema compatibility gate

- Record: p01-src-001503
...
Adopt the schema compatibility gate for svc-event-bus. The implementation emits a decision record with the stable identifier ADR-B4-111, a lifecycle status of released, and an auditable rationale. No individual mailbox, credential, or customer identifier is stored in this record.
