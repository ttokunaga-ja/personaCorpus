# API-B4-11705 — Product Beta R4 API contract

**Schema freeze:** 2026-09-04 · **Status:** reviewed · **Owner:** API Steward

## Scope

This synthetic Aster Loop株式会社 contract defines the `compatibility-rule` resource served by
`svc-observability`. Its record is p01-full-011705 and its canonical source is p01-src-011705.
