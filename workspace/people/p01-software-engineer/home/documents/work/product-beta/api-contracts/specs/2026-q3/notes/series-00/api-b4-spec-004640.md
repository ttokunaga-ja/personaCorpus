# Beta R4 API contract brief: API-B4-4640

Product Beta R4 contract record for Aster Loop株式会社 (synthetic).
Schema freeze: 2026-09-04. The contract governs deployment-intents through svc-release-coordinator.

## Contract profile

- Contract ID: `API-B4-4640`
- Artifact: `p01-full-004640`; source: `p01-src-004640`
