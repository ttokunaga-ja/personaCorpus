# API-B4-10796 — Product Beta R4 API contract

**Schema freeze:** 2026-09-04 · **Status:** planned · **Owner:** API Steward

## Scope

This synthetic Aster Loop株式会社 contract defines the `deployment-intent` resource served by
`svc-release-coordinator`. Its record is p01-full-010796 and its canonical source is p01-src-010796.
