# API-B4-11296 — Product Beta R4 API contract

**Schema freeze:** 2026-09-04 · **Status:** planned · **Owner:** API Steward

## Scope

This synthetic Aster Loop株式会社 contract defines the `schema-review` resource served by
`svc-event-bus`. Its record is p01-full-011296 and its canonical source is p01-src-011296.
