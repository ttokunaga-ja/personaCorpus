# Beta R4 API contract brief: API-B4-0977

Product Beta R4 contract record for Aster Loop株式会社 (synthetic).
Schema freeze: 2026-09-04. The contract governs compatibility-rules through svc-observability.

## Contract profile

- Contract ID: `API-B4-0977`
- Artifact: `p01-full-000977`; source: `p01-src-000977`
