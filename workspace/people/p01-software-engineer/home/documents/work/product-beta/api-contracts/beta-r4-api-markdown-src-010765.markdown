# API-B4-10765 — Product Beta R4 API contract

**Schema freeze:** 2026-09-04 · **Status:** reviewed · **Owner:** API Steward

## Scope

This synthetic Aster Loop株式会社 contract defines the `contract-registry` resource served by
`svc-contract-registry`. Its record is p01-full-010765 and its canonical source is p01-src-010765.
