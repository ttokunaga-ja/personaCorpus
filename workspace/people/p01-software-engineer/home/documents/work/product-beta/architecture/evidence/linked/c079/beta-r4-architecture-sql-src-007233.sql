...
CREATE TABLE IF NOT EXISTS architecture_review_007233 (
...
INSERT INTO architecture_review_007233 VALUES ('ADR-B4-070', 'BETA-R4', '2026-08-17', 'command routing boundary', 225, 'reviewed');
