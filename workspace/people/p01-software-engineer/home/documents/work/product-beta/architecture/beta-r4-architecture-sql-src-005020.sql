...
CREATE TABLE IF NOT EXISTS architecture_review_005020 (
...
INSERT INTO architecture_review_005020 VALUES ('ADR-B4-046', 'BETA-R4', '2026-08-17', 'observability correlation', 225, 'reviewed');
