...
CREATE TABLE IF NOT EXISTS architecture_review_009234 (
...
INSERT INTO architecture_review_009234 VALUES ('ADR-B4-081', 'BETA-R4', '2026-08-17', 'read-model freshness', 225, 'reviewed');
