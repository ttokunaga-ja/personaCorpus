...
CREATE TABLE IF NOT EXISTS architecture_review_004807 (
...
INSERT INTO architecture_review_004807 VALUES ('ADR-B4-032', 'BETA-R4', '2026-08-17', 'replay safety', 225, 'reviewed');
