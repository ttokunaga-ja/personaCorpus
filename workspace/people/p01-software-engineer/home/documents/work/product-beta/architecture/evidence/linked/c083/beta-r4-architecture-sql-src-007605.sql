...
CREATE TABLE IF NOT EXISTS architecture_review_007605 (
...
INSERT INTO architecture_review_007605 VALUES ('ADR-B4-044', 'BETA-R4', '2026-08-17', 'schema evolution review', 225, 'reviewed');
