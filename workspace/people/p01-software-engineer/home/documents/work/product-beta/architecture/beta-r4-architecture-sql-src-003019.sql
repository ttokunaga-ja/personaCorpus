...
CREATE TABLE IF NOT EXISTS architecture_review_003019 (
...
INSERT INTO architecture_review_003019 VALUES ('ADR-B4-035', 'BETA-R4', '2026-08-17', 'failure classification', 225, 'reviewed');
