...
CREATE TABLE IF NOT EXISTS architecture_review_008104 (
...
INSERT INTO architecture_review_008104 VALUES ('ADR-B4-145', 'BETA-R4', '2026-08-17', 'idempotency window', 225, 'reviewed');
