...
CREATE TABLE IF NOT EXISTS architecture_review_008195 (
...
INSERT INTO architecture_review_008195 VALUES ('ADR-B4-037', 'BETA-R4', '2026-08-17', 'deployment lane isolation', 225, 'reviewed');
