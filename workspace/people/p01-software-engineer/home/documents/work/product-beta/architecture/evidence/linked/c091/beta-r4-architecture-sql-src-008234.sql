...
CREATE TABLE IF NOT EXISTS architecture_review_008234 (
...
INSERT INTO architecture_review_008234 VALUES ('ADR-B4-076', 'BETA-R4', '2026-08-17', 'latency budget allocation', 225, 'reviewed');
