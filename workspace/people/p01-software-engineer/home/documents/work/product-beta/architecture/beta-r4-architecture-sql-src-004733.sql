...
CREATE TABLE IF NOT EXISTS architecture_review_004733 (
...
INSERT INTO architecture_review_004733 VALUES ('ADR-B4-157', 'BETA-R4', '2026-08-17', 'consumer rollout sequence', 225, 'reviewed');
