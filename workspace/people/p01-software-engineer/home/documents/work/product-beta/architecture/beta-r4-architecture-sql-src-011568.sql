...
CREATE TABLE IF NOT EXISTS architecture_review_011568 (
...
INSERT INTO architecture_review_011568 VALUES ('ADR-B4-027', 'BETA-R4', '2026-08-17', 'event envelope compatibility', 225, 'reviewed');
