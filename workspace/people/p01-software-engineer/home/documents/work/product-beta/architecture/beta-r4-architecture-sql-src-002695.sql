...
CREATE TABLE IF NOT EXISTS architecture_review_002695 (
...
INSERT INTO architecture_review_002695 VALUES ('ADR-B4-109', 'BETA-R4', '2026-08-17', 'replay safety', 225, 'reviewed');
