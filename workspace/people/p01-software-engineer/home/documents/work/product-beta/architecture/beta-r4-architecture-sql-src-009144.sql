...
CREATE TABLE IF NOT EXISTS architecture_review_009144 (
...
INSERT INTO architecture_review_009144 VALUES ('ADR-B4-190', 'BETA-R4', '2026-08-17', 'idempotency window', 225, 'reviewed');
