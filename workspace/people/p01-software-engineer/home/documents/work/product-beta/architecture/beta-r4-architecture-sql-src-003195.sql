...
CREATE TABLE IF NOT EXISTS architecture_review_003195 (
...
INSERT INTO architecture_review_003195 VALUES ('ADR-B4-012', 'BETA-R4', '2026-08-17', 'failure classification', 225, 'reviewed');
