...
CREATE TABLE IF NOT EXISTS architecture_review_008734 (
...
INSERT INTO architecture_review_008734 VALUES ('ADR-B4-178', 'BETA-R4', '2026-08-17', 'policy evaluation ordering', 225, 'reviewed');
