...
CREATE TABLE IF NOT EXISTS architecture_review_006195 (
...
INSERT INTO architecture_review_006195 VALUES ('ADR-B4-027', 'BETA-R4', '2026-08-17', 'deployment lane isolation', 225, 'reviewed');
