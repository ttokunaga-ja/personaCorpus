...
CREATE TABLE IF NOT EXISTS architecture_review_000983 (
...
INSERT INTO architecture_review_000983 VALUES ('ADR-B4-188', 'BETA-R4', '2026-08-17', 'replay safety', 225, 'reviewed');
