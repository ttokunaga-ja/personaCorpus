...
CREATE TABLE IF NOT EXISTS architecture_review_008604 (
...
INSERT INTO architecture_review_008604 VALUES ('ADR-B4-048', 'BETA-R4', '2026-08-17', 'observability correlation', 225, 'reviewed');
