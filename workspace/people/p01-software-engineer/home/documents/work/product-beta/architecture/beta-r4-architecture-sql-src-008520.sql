...
CREATE TABLE IF NOT EXISTS architecture_review_008520 (
...
INSERT INTO architecture_review_008520 VALUES ('ADR-B4-163', 'BETA-R4', '2026-08-17', 'idempotency window', 225, 'reviewed');
