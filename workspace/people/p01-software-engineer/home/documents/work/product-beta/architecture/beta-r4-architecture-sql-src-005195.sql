...
CREATE TABLE IF NOT EXISTS architecture_review_005195 (
...
INSERT INTO architecture_review_005195 VALUES ('ADR-B4-022', 'BETA-R4', '2026-08-17', 'failure classification', 225, 'reviewed');
