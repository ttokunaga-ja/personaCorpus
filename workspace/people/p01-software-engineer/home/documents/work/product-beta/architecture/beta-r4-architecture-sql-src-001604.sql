...
CREATE TABLE IF NOT EXISTS architecture_review_001604 (
...
INSERT INTO architecture_review_001604 VALUES ('ADR-B4-013', 'BETA-R4', '2026-08-17', 'audit-event retention', 225, 'reviewed');
