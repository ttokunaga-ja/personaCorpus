...
CREATE TABLE IF NOT EXISTS architecture_review_005142 (
...
INSERT INTO architecture_review_005142 VALUES ('ADR-B4-168', 'BETA-R4', '2026-08-17', 'backpressure signaling', 225, 'reviewed');
