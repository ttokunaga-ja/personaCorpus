...
CREATE TABLE IF NOT EXISTS architecture_review_011398 (
...
INSERT INTO architecture_review_011398 VALUES ('ADR-B4-056', 'BETA-R4', '2026-08-17', 'backpressure signaling', 225, 'reviewed');
