# Product Beta R4 replay safety review record 000855

Aster Loop株式会社 / BETA-R4 / ADR-B4-060 / architecture review 2026-08-17 / design p95 budget 225 ms
...
- Budget: 170 ms allocated to this path segment; end-to-end design target remains 225 ms.
- Evidence: trace label `beta-r4-000855` is reserved for synthetic staging validation.
