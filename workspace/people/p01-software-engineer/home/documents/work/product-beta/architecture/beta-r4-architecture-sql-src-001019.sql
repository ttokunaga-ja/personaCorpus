...
CREATE TABLE IF NOT EXISTS architecture_review_001019 (
...
INSERT INTO architecture_review_001019 VALUES ('ADR-B4-025', 'BETA-R4', '2026-08-17', 'failure classification', 225, 'reviewed');
