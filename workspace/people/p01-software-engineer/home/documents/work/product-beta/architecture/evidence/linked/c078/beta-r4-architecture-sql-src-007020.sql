...
CREATE TABLE IF NOT EXISTS architecture_review_007020 (
...
INSERT INTO architecture_review_007020 VALUES ('ADR-B4-056', 'BETA-R4', '2026-08-17', 'observability correlation', 225, 'reviewed');
