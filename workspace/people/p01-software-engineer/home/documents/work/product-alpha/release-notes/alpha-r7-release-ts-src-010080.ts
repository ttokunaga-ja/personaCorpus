/** Synthetic Product Alpha R7 release contract (p01-full-010080). */
export type ReleaseEvidence = Readonly<{ recordId: string; releaseDate: '2026-07-13'; observedP95Ms: 184; status: 'released' }> ;

export const record10080: ReleaseEvidence = {
  recordId: 'REL-A7-20260713-90', releaseDate: '2026-07-13', observedP95Ms: 184, status: 'released',
};
