//! Synthetic Product Alpha R7 release evidence (p01-full-006942).
#[derive(Debug, Clone, Copy)]
pub struct ReleaseEvidence { pub record_id: &'static str, pub observed_p95_ms: u16 }

pub const EVIDENCE: ReleaseEvidence = ReleaseEvidence { record_id: "REL-A7-20260719-56", observed_p95_ms: 184 };
