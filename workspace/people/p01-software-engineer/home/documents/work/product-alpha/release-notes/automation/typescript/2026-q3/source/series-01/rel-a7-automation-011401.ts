/** Synthetic Product Alpha R7 release contract (p01-full-011401). */
export type ReleaseEvidence = Readonly<{ recordId: string; releaseDate: '2026-07-13'; observedP95Ms: 184; status: 'reviewed' }> ;

export const record11401: ReleaseEvidence = {
  recordId: 'REL-A7-20260714-53', releaseDate: '2026-07-13', observedP95Ms: 184, status: 'reviewed',
};
