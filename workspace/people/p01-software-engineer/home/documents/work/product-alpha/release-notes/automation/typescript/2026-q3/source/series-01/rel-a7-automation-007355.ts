/** Synthetic Product Alpha R7 release contract (p01-full-007355). */
export type ReleaseEvidence = Readonly<{ recordId: string; releaseDate: '2026-07-13'; observedP95Ms: 184; status: 'closed' }> ;

export const record7355: ReleaseEvidence = {
  recordId: 'REL-A7-20260716-81', releaseDate: '2026-07-13', observedP95Ms: 184, status: 'closed',
};
