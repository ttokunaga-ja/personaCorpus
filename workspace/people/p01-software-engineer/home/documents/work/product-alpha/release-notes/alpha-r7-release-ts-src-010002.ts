/** Synthetic Product Alpha R7 release contract (p01-full-010002). */
export type ReleaseEvidence = Readonly<{ recordId: string; releaseDate: '2026-07-13'; observedP95Ms: 184; status: 'approved' }> ;

export const record10002: ReleaseEvidence = {
  recordId: 'REL-A7-20260715-12', releaseDate: '2026-07-13', observedP95Ms: 184, status: 'approved',
};
