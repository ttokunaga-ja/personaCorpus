/** Synthetic Product Alpha R7 release contract (p01-full-011044). */
export type ReleaseEvidence = Readonly<{ recordId: string; releaseDate: '2026-07-13'; observedP95Ms: 184; status: 'released' }> ;

export const record11044: ReleaseEvidence = {
  recordId: 'REL-A7-20260717-84', releaseDate: '2026-07-13', observedP95Ms: 184, status: 'released',
};
