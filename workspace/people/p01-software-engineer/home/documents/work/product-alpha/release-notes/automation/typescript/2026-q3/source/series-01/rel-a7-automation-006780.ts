/** Synthetic Product Alpha R7 release contract (p01-full-006780). */
export type ReleaseEvidence = Readonly<{ recordId: string; releaseDate: '2026-07-13'; observedP95Ms: 184; status: 'released' }> ;

export const record6780: ReleaseEvidence = {
  recordId: 'REL-A7-20260717-88', releaseDate: '2026-07-13', observedP95Ms: 184, status: 'released',
};
