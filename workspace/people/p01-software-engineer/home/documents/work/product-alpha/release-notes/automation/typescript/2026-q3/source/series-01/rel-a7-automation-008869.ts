/** Synthetic Product Alpha R7 release contract (p01-full-008869). */
export type ReleaseEvidence = Readonly<{ recordId: string; releaseDate: '2026-07-13'; observedP95Ms: 184; status: 'reviewed' }> ;

export const record8869: ReleaseEvidence = {
  recordId: 'REL-A7-20260718-43', releaseDate: '2026-07-13', observedP95Ms: 184, status: 'reviewed',
};
