/** Synthetic Product Alpha R7 release contract (p01-full-011920). */
export type ReleaseEvidence = Readonly<{ recordId: string; releaseDate: '2026-07-13'; observedP95Ms: 184; status: 'released' }> ;

export const record11920: ReleaseEvidence = {
  recordId: 'REL-A7-20260713-87', releaseDate: '2026-07-13', observedP95Ms: 184, status: 'released',
};
