# API-A7-0358: event-deliveries publish contract
...
This synthetic Aster Loop API contract records the `publish` interaction for
`event-deliveries`. The request enters through `svc-edge-api` and is catalogued by
...
The API Steward marked API-A7-0358 reviewed with an explicit `reviewed` lifecycle
