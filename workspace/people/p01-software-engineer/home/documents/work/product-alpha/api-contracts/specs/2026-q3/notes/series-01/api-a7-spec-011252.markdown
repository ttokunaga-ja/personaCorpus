# API-A7-11252 — release-gates register
...
This synthetic Aster Loop API note defines the `register` interaction for
`release-gates`. `svc-edge-api` accepts the request and `svc-contract-registry`
...
Contract API-A7-11252 is a synthetic engineering record; it contains no customer,
