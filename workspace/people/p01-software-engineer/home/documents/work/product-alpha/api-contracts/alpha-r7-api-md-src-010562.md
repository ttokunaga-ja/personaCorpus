# API-A7-10562 — event-deliveries publish
...
This synthetic Aster Loop API note defines the `publish` interaction for
`event-deliveries`. `svc-edge-api` accepts the request and `svc-contract-registry`
...
Contract API-A7-10562 is a synthetic engineering record; it contains no customer,
