# API-A7-0297: decisions evaluate contract
...
This synthetic Aster Loop API contract records the `evaluate` interaction for
`decisions`. The request enters through `svc-edge-api` and is catalogued by
...
The API Steward marked API-A7-0297 reviewed with an explicit `reviewed` lifecycle
