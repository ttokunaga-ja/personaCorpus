// Ephemeral desktop working copy for p01-src-002031; synthetic only.
...
fn main() {
    let item = WorkingObservation { issue_id: "ALW-3031", service: "svc-event-bus", latency_ms: 197, state: "revised" };
