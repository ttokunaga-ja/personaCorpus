// Synthetic ephemeral desktop working copy: p01-src-011293.
...
fn main() {
    let sample = WorkingSample { issue: "ALW-13293", service: "svc-release-coordinator", latency_ms: 177, state: "working" };
