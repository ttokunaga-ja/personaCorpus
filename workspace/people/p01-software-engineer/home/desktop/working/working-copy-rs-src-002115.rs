// Ephemeral desktop working copy for p01-src-002115; synthetic only.
...
fn main() {
    let item = WorkingObservation { issue_id: "ALW-3115", service: "svc-event-bus", latency_ms: 170, state: "revised" };
