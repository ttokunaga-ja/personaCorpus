// Ephemeral desktop working copy for p01-src-003328; synthetic only.
...
fn main() {
    let item = WorkingObservation { issue_id: "ALW-4328", service: "svc-observability", latency_ms: 199, state: "draft" };
