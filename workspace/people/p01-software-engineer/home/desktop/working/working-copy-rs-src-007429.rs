// Synthetic ephemeral desktop working copy: p01-src-007429.
...
fn main() {
    let sample = WorkingSample { issue: "ALW-9429", service: "svc-release-coordinator", latency_ms: 188, state: "working" };
