// Ephemeral desktop working copy for p01-src-002039; synthetic only.
...
fn main() {
    let item = WorkingObservation { issue_id: "ALW-3039", service: "svc-contract-registry", latency_ms: 168, state: "revised" };
