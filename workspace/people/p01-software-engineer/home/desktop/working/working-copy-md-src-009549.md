# Desktop working note: ALW-11549
...
It references ADR-197 and preserves the asynchronous release-gate boundary between
Release Coordinator and Decision Store. The observed working-path value is 169 ms;
