// Synthetic ephemeral desktop working copy: p01-src-009073.
...
fn main() {
    let sample = WorkingSample { issue: "ALW-11073", service: "svc-release-coordinator", latency_ms: 189, state: "working" };
