// Synthetic ephemeral desktop working copy: p01-src-009031.
...
fn main() {
    let sample = WorkingSample { issue: "ALW-11031", service: "svc-release-coordinator", latency_ms: 178, state: "revised" };
