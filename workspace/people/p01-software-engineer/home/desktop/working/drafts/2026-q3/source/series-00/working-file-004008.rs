// Ephemeral desktop working copy for p01-src-004008; synthetic only.
...
fn main() {
    let item = WorkingObservation { issue_id: "ALW-5008", service: "svc-edge-api", latency_ms: 176, state: "draft" };
