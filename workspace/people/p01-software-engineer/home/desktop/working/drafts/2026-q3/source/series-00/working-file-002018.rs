// Ephemeral desktop working copy for p01-src-002018; synthetic only.
...
fn main() {
    let item = WorkingObservation { issue_id: "ALW-3018", service: "svc-decision-store", latency_ms: 184, state: "review-pending" };
