// Ephemeral desktop working copy for p01-src-002136; synthetic only.
...
fn main() {
    let item = WorkingObservation { issue_id: "ALW-3136", service: "svc-edge-api", latency_ms: 191, state: "draft" };
