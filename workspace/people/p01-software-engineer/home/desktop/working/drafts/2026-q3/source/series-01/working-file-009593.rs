// Synthetic ephemeral desktop working copy: p01-src-009593.
...
fn main() {
    let sample = WorkingSample { issue: "ALW-11593", service: "svc-contract-registry", latency_ms: 182, state: "working" };
