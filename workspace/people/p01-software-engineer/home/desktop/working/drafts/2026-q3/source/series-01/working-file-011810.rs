// Synthetic ephemeral desktop working copy: p01-src-011810.
...
fn main() {
    let sample = WorkingSample { issue: "ALW-13810", service: "svc-decision-store", latency_ms: 198, state: "review-pending" };
