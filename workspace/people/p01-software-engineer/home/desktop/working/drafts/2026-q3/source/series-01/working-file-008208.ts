// Synthetic ephemeral desktop working copy: p01-src-008208.
type WorkingSample = { issue: string; service: string; latencyMs: number; state: string };
const sample: WorkingSample = { issue: "ALW-10208", service: "svc-edge-api", latencyMs: 192, state: "draft" };
export const workingSource = "p01-src-008208";
