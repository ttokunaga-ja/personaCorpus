// Synthetic ephemeral desktop working copy: p01-src-006409.
...
fn main() {
    let sample = WorkingSample { issue: "ALW-8409", service: "svc-release-coordinator", latency_ms: 191, state: "working" };
