// Ephemeral desktop working copy for p01-src-003846; synthetic only.
...
fn main() {
    let item = WorkingObservation { issue_id: "ALW-4846", service: "svc-edge-api", latency_ms: 199, state: "review-pending" };
