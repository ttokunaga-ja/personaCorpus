// Synthetic ephemeral desktop working copy: p01-src-007309.
...
fn main() {
    let sample = WorkingSample { issue: "ALW-9309", service: "svc-release-coordinator", latency_ms: 192, state: "working" };
