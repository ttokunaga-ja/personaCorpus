// Ephemeral desktop working copy for p01-src-004246; synthetic only.
...
fn main() {
    let item = WorkingObservation { issue_id: "ALW-5246", service: "svc-observability", latency_ms: 192, state: "review-pending" };
