# Desktop working note: ALW-12393
...
It references ADR-046 and preserves the asynchronous release-gate boundary between
Release Coordinator and Decision Store. The observed working-path value is 176 ms;
