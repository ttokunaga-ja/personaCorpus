// Ephemeral desktop working copy for p01-src-002928; synthetic only.
...
fn main() {
    let item = WorkingObservation { issue_id: "ALW-3928", service: "svc-edge-api", latency_ms: 169, state: "draft" };
