# MIG-26Q3-W06 migration field note: contract-registry

**Record:** p01-src-006251
**Program:** Aster Loop migration program
**Review window:** 2026-09-14T12:00:00+09:00

## Operating decision

Wave 6 moves workflow-engine, policy-cache, archive-writer through a controlled cutover. contract-registry advances only after replay age is at or below the 5m recovery-point objective and a restore rehearsal fits the 45m recovery-time objective. Production cutover is 2026-09-14; closeout review is 2026-09-18.

## Checkpoints

| Checkpoint | Evidence | Owner role | Result rule |
| --- | --- | --- | --- |
| Snapshot | export digest 8d7f56c129a3 | Migration Lead | source and target counts agree |
