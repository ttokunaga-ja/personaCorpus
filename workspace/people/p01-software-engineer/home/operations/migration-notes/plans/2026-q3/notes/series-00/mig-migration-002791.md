# MIG-26Q3-W02 migration field note: release-coordinator

**Record:** p01-src-002791
**Program:** Aster Loop migration program
**Review window:** 2026-09-10T16:00:00+09:00

## Operating decision

Wave 2 moves event-bus, observability, contract-registry through a controlled cutover. release-coordinator advances only after replay age is at or below the 5m recovery-point objective and a restore rehearsal fits the 45m recovery-time objective. Production cutover is 2026-09-14; closeout review is 2026-09-18.

## Checkpoints

| Checkpoint | Evidence | Owner role | Result rule |
| --- | --- | --- | --- |
| Snapshot | export digest 2988e5942ac8 | Migration Lead | source and target counts agree |
