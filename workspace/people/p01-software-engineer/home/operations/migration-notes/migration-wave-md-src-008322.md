# MIG-26Q3-W01 migration field note: identity-sync

**Record:** p01-src-008322
**Program:** Aster Loop migration program
**Review window:** 2026-09-09T11:00:00+09:00

## Operating decision

Wave 1 moves edge-api, release-coordinator, decision-store through a controlled cutover. identity-sync advances only after replay age is at or below the 5m recovery-point objective and a restore rehearsal fits the 45m recovery-time objective. Production cutover is 2026-09-14; closeout review is 2026-09-18.

## Checkpoints

| Checkpoint | Evidence | Owner role | Result rule |
| --- | --- | --- | --- |
| Snapshot | export digest 735842c67dad | Migration Lead | source and target counts agree |
