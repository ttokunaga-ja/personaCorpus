"""Synthetic VND-26Q3-154 platform evaluation helper."""
EVALUATION_ID = 'VND-26Q3-154'
VENDOR = 'Platform Juniper'

def weighted_score(latency_ms: int = 155, availability_pct: float = 99.88, coverage_pct: int = 87) -> float:
