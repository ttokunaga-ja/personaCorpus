"""Synthetic VND-26Q3-228 platform evaluation helper."""
EVALUATION_ID = 'VND-26Q3-228'
VENDOR = 'Platform Quartz'

def weighted_score(latency_ms: int = 191, availability_pct: float = 99.96, coverage_pct: int = 95) -> float:
