"""Synthetic VND-26Q3-155 platform evaluation helper."""
EVALUATION_ID = 'VND-26Q3-155'
VENDOR = 'Platform Meridian'

def weighted_score(latency_ms: int = 167, availability_pct: float = 99.85, coverage_pct: int = 85) -> float:
