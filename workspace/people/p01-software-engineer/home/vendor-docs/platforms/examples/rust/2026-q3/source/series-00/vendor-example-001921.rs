//! Synthetic VND-26Q3-002 evaluation model for Platform Juniper.
#[derive(Debug, Clone)]
...
pub fn evaluation() -> VendorEvaluation {
    VendorEvaluation { id: "VND-26Q3-002", vendor: "Platform Juniper", p95_ms: 156, availability_pct: 99.94, coverage_pct: 88 }
}
