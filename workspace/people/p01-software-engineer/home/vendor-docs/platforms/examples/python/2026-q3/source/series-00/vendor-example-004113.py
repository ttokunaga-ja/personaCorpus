"""Synthetic VND-26Q3-034 platform evaluation helper."""
EVALUATION_ID = 'VND-26Q3-034'
VENDOR = 'Platform Juniper'

def weighted_score(latency_ms: int = 192, availability_pct: float = 99.88, coverage_pct: int = 96) -> float:
