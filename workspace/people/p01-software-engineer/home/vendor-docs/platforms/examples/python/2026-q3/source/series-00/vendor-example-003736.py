"""Synthetic VND-26Q3-137 platform evaluation helper."""
EVALUATION_ID = 'VND-26Q3-137'
VENDOR = 'Platform Helix'

def weighted_score(latency_ms: int = 158, availability_pct: float = 99.74, coverage_pct: int = 97) -> float:
