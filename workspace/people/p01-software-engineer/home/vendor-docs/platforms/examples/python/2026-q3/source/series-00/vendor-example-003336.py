"""Synthetic VND-26Q3-217 platform evaluation helper."""
EVALUATION_ID = 'VND-26Q3-217'
VENDOR = 'Platform Helix'

def weighted_score(latency_ms: int = 150, availability_pct: float = 99.74, coverage_pct: int = 96) -> float:
