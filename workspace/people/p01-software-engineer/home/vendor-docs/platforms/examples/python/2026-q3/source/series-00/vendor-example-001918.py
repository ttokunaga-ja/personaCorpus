"""Synthetic VND-26Q3-239 platform evaluation helper."""
EVALUATION_ID = 'VND-26Q3-239'
VENDOR = 'Platform Meridian'

def weighted_score(latency_ms: int = 153, availability_pct: float = 99.73, coverage_pct: int = 85) -> float:
