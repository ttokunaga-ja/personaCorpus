"""Synthetic VND-26Q3-144 platform evaluation helper."""
EVALUATION_ID = 'VND-26Q3-144'
VENDOR = 'Platform Quartz'

def weighted_score(latency_ms: int = 156, availability_pct: float = 99.83, coverage_pct: int = 95) -> float:
