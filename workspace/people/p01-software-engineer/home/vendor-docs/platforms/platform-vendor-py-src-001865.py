"""Synthetic VND-26Q3-186 platform evaluation helper."""
EVALUATION_ID = 'VND-26Q3-186'
VENDOR = 'Platform Juniper'

def weighted_score(latency_ms: int = 149, availability_pct: float = 99.77, coverage_pct: int = 95) -> float:
